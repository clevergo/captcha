...
=====================
	...
	import "github.com/clevergo/captcha"

**Note that, this project is fork from [https://github.com/dchest/captcha](https://github.com/dchest/captcha)**

**I just added support for fasthttp.**
